...
(PACRA company-incorporation and business-name forms, ZDA investor
applications + guide, Lands Act land applications, NAPSA / WCFCB employer
registrations, RTSA vehicle and licensing forms, the Zambian passport
application, NHIMA forms, High Court fee schedules and procedural forms,
plus e-government procedure guides for tasks done on official online
portals such as ZRA TaxOnline and Immigration eServices, etc.). When a
...
Forms Levy holds — search by these EXACT titles:
  • Company incorporation -> "PACRA Companies Form 3 (Application for Incorporation)", "PACRA Companies Form 21 (Beneficial Ownership Declaration)", "PACRA Standard Articles of Association"; name clearance -> "PACRA Companies Form 1 (Name Clearance)"; change of shareholding / beneficial owner -> "PACRA Companies Form 20 (Change in Shareholding or Beneficial Owner)"
  • Business name registration -> "PACRA BN Form III (Business Name Registration)"; change a business name's particulars -> "PACRA BN Form XI (Change in Business Name Particulars)"; cease a business name -> "PACRA BN Form XIV (Cessation of Business)"
  • NAPSA employer registration -> "NAPSA Employer Form" (the NAPSA / ZRA / ZDA one-stop-shop registration form); Workers' comp -> "WCFCB Employer Registration"
  ...
  • Driver's licence renewal -> "RTSA Driving Licence Renewal Requirements"; PSV driver's licence -> "RTSA PSV Driving Licence Requirements"; Highway Code / learner study -> "Zambian Highway Code" (a new/first driver's licence is applied for in person at an RTSA station, no downloadable form)
...
form ("help me fill the PACRA incorporation form", "complete the business
name form for me"): (1) `search_corpus` to find the form and its fields; (2) list the
